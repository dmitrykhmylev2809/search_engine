...
//      новый участок кода
//            fetch(send.statistics.address, {
//              method: send.statistics.type,
//              headers: {
...
//                if (result.result) {
//                  // Обновление значений переменных totalSites, totalPages, totalLemmas
//                  $('#totalSites').text(result.statistics.total.sites);
//                  $('#totalPages').text(result.statistics.total.pages);
//                  $('#totalLemmas').text(result.statistics.total.lemmas);
//
//                  // Другой код для обновления интерфейса на основе полученных данных
//                  // ...
//                } else {
...
//                shiftCheck($this);
//              }
//              // Сохранить состояние кнопки "Start Indexing" в Local Storage
//              localStorage.setItem('indexingStatus', 'running');
//            } else {
//              if ($this.next('.API-error').length) {
//                $this.next('.API-error').text(result.error);
//              } else {
...
//                    shiftCheck($this);
//                  }
//                  // Удалить сохраненное состояние кнопки "Start Indexing" из Local Storage
//                  localStorage.removeItem('indexingStatus');
//                } else {
//                  if ($this.next('.API-error').length) {
//                    $this.next('.API-error').text(result.error);
//                  } else {
...
//                send['statistics'].action(result, $this);
//
//                // Call the updateStatistics function recursively with a delay
//                setTimeout(updateStatistics, 5000); // Update every 5 seconds
//            },
//            $('.Statistics')
//        );
//    }
...
//          });
//
//          // Проверить состояние индексации при инициализации страницы или переходе на вкладку "Management"
//          $(document).ready(function() {
//            var indexingStatus = localStorage.getItem('indexingStatus');
...
//                                            }
//
//                  // Логика обработки запроса поиска...
//                  break;
//                // Другие случаи...
//              }
//              sendData(
